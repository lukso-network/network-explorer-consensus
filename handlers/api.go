...
// @description **Advanced and reliable API for accessing comprehensive LUKSO blockchain data.**
// @description
...
// @description ```bash
// @description curl -H 'apikey: <your_key>' https://explorer.consensus.testnet.lukso.network/api/v1/slot/1
// @description ```
// @x-tagGroups [{"name":"Consensus Layer","tags":["Epochs", "Slots", "Validators", "Rewards", "Sync Committees"]},{"name":"Execution Layer","tags":["Validator Deposits", "Blocks", "Addresses", "Gas"]},{"name":"Other","tags":["Network", "User", "Misc"]}]
